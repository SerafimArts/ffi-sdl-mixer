...
#ifndef _SDL_MIXER_VERSION_GTE
    #define _SDL_MIXER_VERSION_GTE(x) 1
#endif
 ...
 * \sa Mix_QuerySpec
 */
#if _SDL_MIXER_VERSION_GTE(2.0.2)
 ...
 * \sa Mix_FreeChunk
 */
#if _SDL_MIXER_VERSION_GTE(2.5.3)
 ...
 * \sa Mix_GetMusicDecoder
 */
#if _SDL_MIXER_VERSION_GTE(2.5.0)
